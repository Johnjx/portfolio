...
export const Focus = () => (
    <section className="focus bg-prim" id="focus-section">
        ...
        <div className="border-2 rounded-md shadow-md hover:border-quad flex flex-col items-center h-4/5
            ...
            <article className='focus-piece'>
                ...
                <p className='text-center w-3/4 font-open hidden lg:block'>
            ...
            <article className='focus-piece'>
                ...
                <h5 className='text-xl font-play text-center'>Artificial Intelligence</h5>
                <p className='text-center w-3/4 font-open hidden lg:block'>
            ...
            <article className='hidden 2xl:flex 2xl:flex-col 2xl:h-2/5 2xl:w-4/12
