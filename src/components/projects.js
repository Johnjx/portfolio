...
export const Projects = () => {
    ...
    <section className="projects border-b-4 border-quad" id="showcase-section">
        ...
        <div className="h-4/5 w-3/4 border-2 rounded-md shadow-md hover:border-quad bg-emerald-100
                        m-auto mt-8 transition-all
                        xs:w-screen xs:h-4/5 lg:w-3/4 lg:h-5/6
                        2xl:w-3/5 2xl:h-5/6" onMouseEnter={slideIn} onMouseLeave={slideOut}>
            <a className="feature" href="https://rainbow-muffin-38c867.netlify.app/">
                ...
                <img src="/assets/nasa-website.png" alt="nasa APOD website"></img>
            </a>
